...
function Checkout() {
    ...
    const [productDetails, setProductdetails] = useState(loc.state.productDetails);
                            ...
                            <Col sm={4} xs={8}>
                                <Row>
                                    ...
                                    <div className="d-flex align-center my-2">
                                        <Button variant="outline-success" onClick={QtySub}>
                                            -
                                        </Button>{" "}
                                        <strong style={{ fontSize: "16px" }} className="d-inline-block align-content-center">
                                            {" "}
                                            &nbsp; {qty} &nbsp;
                                        </strong>
                                        <Button variant="outline-success" onClick={QtyAdd}>
                                            +
                                        </Button>{" "} &nbsp;


                                    </div>
                                    <strong className="align-content-center fs-5">₹ {totalrate.toFixed(2)}</strong>
